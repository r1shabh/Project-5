...
public class SongListTest extends student.TestCase {
     ...
     * so watch that
     * @throws FileNotFoundException if the songList file cannot be found
     */
    public void testReadResponses() throws FileNotFoundException {
        SongList data = new DataReader("SongList2017S.csv").readSongs();
        String nonExistentFile =
            "There is no way I should be a file on whatever device this test is running on";
        ...
        data.readResponses("MusicSurveyData2017S.csv"); //The songs in the list should now be updated with responses
