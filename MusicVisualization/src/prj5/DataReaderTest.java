...
public class DataReaderTest extends student.TestCase{
     ...
     * @throws FileNotFoundException if the file passed in 
    ...
    public void testReadSongs() throws FileNotFoundException {
        ...
        try{
        DataReader throwing = new DataReader("I should not be a real filename");
        throwing.readSongs();
        ...
        assertEquals(new Song("All You Need Is Love", "The Beatles", 1967, "pop rock"), output.getEntry(0));
        assertEquals(new Song("You Can't Always Get What You Want", "The Rolling Stones", 1969, "pop rock"), output.getEntry(61));
